        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for(int i = 0 ; i < usersList.size() ; i++){
                ...
                if(i != usersList.size() - 1){
                    out.print("{\"id\":" + users.getId() + ",\"firstName\":\"" + users.getFirstname() + "\",\"lastName\":\"" + users.getLastname() + "\",\"email\":\"" + users.getEmail() + "\",\"password\":\"" + users.getPassword() + "\"},");   
                }
                else {
                    out.print("{\"id\":" + users.getId() + ",\"firstName\":\"" + users.getFirstname() + "\",\"lastName\":\"" + users.getLastname() + "\",\"email\":\"" + users.getEmail() + "\",\"password\":\"" + users.getPassword() + "\"}");   
                }
